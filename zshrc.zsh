...
plugins=(colored-man-pages colorize command-not-found cp extract gitfast history history-substring-search pip themes time-commands tmux virtualenv zsh-syntax-highlighting)
